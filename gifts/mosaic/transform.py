...
def transform_img_xml(src_imgpath,src_xmlpath,transforms,img_save_name):
    ...
    return:
        ...
        createdxml:转换生成的新标签
    '''
    src_img = cv2.imread("VOC2007/img")
    src_xml = voc_xml.get_xml_tree("VOC2007/xml")
...
def transform_file_from_dirs(imgs_xmls_dirs,imgs_save_dir,xmls_save_dir,transforms,N=10):
...
def main():
    imgs_xmls_dirs = {0:{'imgs_dir':'J:/实验代码/augment-master/VOC2007/img/',\
                    'bk_imgs_dir':'J:/实验代码/augment-master/VOC2007/img/',\
                    'xmls_dir':'J:/实验代码/augment-master/VOC2007/xml/'},
                        
                     }
    
    imgs_save_dir = 'J:/实验代码/augment-master/VOC2007/img/'
    if not os.path.exists(imgs_save_dir):
        os.makedirs(imgs_save_dir)
    xmls_save_dir ='J:/实验代码/augment-master/VOC2007/xml/'
