...
"""
    Original implementation from https://github.com/miaoshuyu/object-detection-usages
"""


class GHMC_loss(torch.nn.Module):
    def __init__(self, bins=30, momentum=0.75, use_sigmiod=True, loss_weight=1.0):
